        ...
        if 'sid' in cookie:
            ...
            if session_store.get('authenticated'):
                ...
                result = """<section id="initial">
                                ...
                                <a href = "remove.py">Toggle Delete</a>
                ...
                try:
                    ...
                    for each in cursor.fetchall():
                        result += """<section>
                                        ...
                                        <p>%s%s</p>
                                        <p>%s%s</p>
                                    </section>""" % (each['dest'], nice[0], each['price'], nice[1], each['airline'],nice[2], each['flight_number'],nice[3], each['departs'],nice[4], each['returns'])
                    cursor.close()
                    connection.close()
